(function () {
  ...
  const d = {
    data() {
      return { isOpen: !1, displayIndex: 1 };
    },
    computed: {
      questionField() {
    ...
    mounted() {
      this.$nextTick(() => {
        (this.updateDisplayIndex(), this.resizeAnswerInput());
      });
    },
    updated() {
      this.$nextTick(() => {
    ...
    methods: {
      ...
      updateQuestion(e) {
        this.update({ [this.content.question !== void 0 ? 'question' : 'summary']: e });
      },
      updateAnswer(e) {
        this.update({ [this.content.answer !== void 0 ? 'answer' : 'details']: e });
      },
      updateDisplayIndex() {
        var r;
        const e = (r = this.$el) == null ? void 0 : r.closest('.k-block-container-type-accordion');
        if (!e || !e.parentElement) {
          this.displayIndex = 1;
          return;
        }
        const n = Array.from(e.parentElement.children)
          .filter(i => i.classList.contains('k-block-container-type-accordion'))
          .indexOf(e);
        this.displayIndex = n >= 0 ? n + 1 : 1;
      },
      resizeAnswerInput() {
        var t;
        const e =
          (t = this.$el) == null ? void 0 : t.querySelector('.k-block-type-accordion-answer-input');
  ...
  var u = function () {
      var t = this,
        n = t._self._c;
      return n('div', { staticClass: 'k-block-type-accordion', on: { dblclick: t.open } }, [
        n(
          'div',
          {
            staticClass: 'k-block-type-accordion-item k-block-faq-item',
            class: { 'is-open': t.isOpen },
          },
          [
            n(
              'button',
              {
                staticClass: 'k-block-type-accordion-header k-block-faq-toggle',
                attrs: { type: 'button' },
                on: {
                  click: function (r) {
                    t.isOpen = !t.isOpen;
              ...
              [
                n('div', { staticClass: 'k-block-faq-index' }, [
                  t._v(' ' + t._s(t.displayIndex) + ' '),
                ]),
                n('div', { staticClass: 'k-block-type-accordion-question k-block-faq-preview' }, [
                  n('div', [t._v(t._s(t.stripHtml(t.questionValue) || 'Frage eingeben…'))]),
                ]),
                n('k-icon', {
                  staticClass: 'k-icon k-block-faq-icon',
            ...
            n(
              'div',
              {
                ...
                staticClass: 'k-block-type-accordion-body k-block-faq-body',
              },
              [
                n('textarea', {
                  staticClass: 'k-block-type-accordion-answer-input k-block-faq-answer-input',
                  attrs: {
                    rows: '1',
                    placeholder: t.answerField.placeholder || 'Antwort eingeben…',
                  },
                  domProps: { value: t.stripHtml(t.answerValue) },
                  on: {
                    input: function (r) {
                      (t.updateAnswer(r.target.value), t.resizeAnswerInput());
                    },
                  },
                }),
              ]
  ...
  var v = function () {
    ...
    w = [],
    x = s(y, v, w, !1, null, 'bdf9415b');
  const $ = x.exports,
    C = {
      data() {
        return { text: '', pagePreviewText: '', pagePreviewHeadline: '', imagePreviewUrl: '' };
      },
      computed: {
        cardType() {
  ...
  var F = function () {
      var t = this,
        n = t._self._c;
      return n('div', { staticClass: 'k-block-type k-block-type-card', on: { dblclick: t.open } }, [
        n('div', { staticClass: 'k-block-body' }, [
          t.imagePreviewUrl
            ? n(
                'div',
                { staticClass: 'k-block-card-image' },
                [
                  n('k-frame', { attrs: { cover: '', ratio: '1/1' } }, [
            ...
            : n(
                'div',
                { staticClass: 'k-block-card-image-placeholder' },
                [n('k-icon', { attrs: { type: 'info-card' } })],
                1
              ),
          n('div', { staticClass: 'k-block-card-content' }, [
            t.headline_html
              ? n('div', {
                  staticClass: 'k-block-card-headline',
                  domProps: { innerHTML: t._s(t.headline_html) },
                })
              : t._e(),
            t.subheadline_html
              ? n('div', {
                  staticClass: 'k-block-card-subheadline',
                  domProps: { innerHTML: t._s(t.subheadline_html) },
                })
              : t._e(),
            t.manual_content_html
              ? n('div', {
                  staticClass: 'k-block-card-text',
                  domProps: { innerHTML: t._s(t.manual_content_html) },
                })
              : n('div', { staticClass: 'k-block-card-text' }, [
                  ...
                  return n(
                    ...
                    [
                      n('k-writer', {
                        ...
                        on: {
                          input: function (a) {
                            return t.updateItem(t.content, i, 'linktext', a);
                          },
                        },
                      }),
                    ],
  ...
  var P = function () {
      ...
      return n(
        'div',
        { staticClass: 'k-block-type k-block-type-download', on: { dblclick: t.open } },
        [
          n('div', { staticClass: 'k-block-body' }, [
            t.titleText
              ? n('div', { staticClass: 'k-block-download-title' }, [
                  n('strong', [t._v(t._s(t.titleText))]),
                ])
              : t._e(),
            t.fileName
              ? n('div', { staticClass: 'k-block-download-preview' }, [
                  n('div', { staticClass: 'k-block-download-item' }, [
                    n(
                      'div',
                      { staticClass: 'k-block-download-icon' },
                      [n('k-icon', { attrs: { type: 'download' } })],
                      1
                    ),
                    n('div', { staticClass: 'k-block-download-content' }, [
                      n('div', { staticClass: 'k-block-download-file' }, [
                        t._v(' ' + t._s(t.fileName) + ' '),
                      ]),
                      t.descriptionText
                        ? n('div', { staticClass: 'k-block-download-text' }, [
              ...
              : n('div', { staticClass: 'k-block-empty' }, [t._v(' Keine Datei ausgewählt ')]),
            t.scheduleLabel
              ? n('div', { staticClass: 'k-block-download-schedule' }, [
      ...
      methods: {
        normalizeFaqItems(e) {
          ...
          if (e && typeof e == 'object') {
            if (Array.isArray(e.blocks)) return e.blocks;
            if (Array.isArray(e.value)) return e.value;
          }
          if (typeof e == 'string' && e.trim() !== '')
            try {
              const t = JSON.parse(e);
              return this.normalizeFaqItems(t);
            } catch {
              return [];
            }
          return [];
        ...
        questionValue(e) {
          return !e || !e.content
            ? ''
            : this.stripHtml(e.content.question || e.content.summary || '');
        },
        questionRawValue(e) {
          return !e || !e.content ? '' : e.content.question || e.content.summary || '';
        },
        answerValue(e) {
        ...
        syncOpenItems() {
          this.openItems.length || (this.items.length === 1 && (this.openItems = [0]));
        },
        isOpen(e) {
        ...
        resizeAnswerInputs() {
          var t;
          (
            ((t = this.$el) == null ? void 0 : t.querySelectorAll('.k-block-faq-answer-input')) ||
            []
          ).forEach(n => this.resizeTextarea(n));
        },
        updateItem(e, t, n) {
  ...
  var R = function () {
      var t = this,
        n = t._self._c;
      return n('div', { staticClass: 'k-block-type k-block-type-faq', on: { dblclick: t.open } }, [
        n(
          'div',
          { staticClass: 'k-block-body' },
          [
            n(
              'div',
              { staticClass: 'k-block-faq-title' },
              [
                n('k-icon', { attrs: { type: 'question' } }),
                n('strong', [t._v(t._s(t.headingTitle))]),
              ],
              1
            ),
            n('k-writer', {
              staticClass: 'k-block-faq-heading',
              attrs: {
                inline: t.headingField.inline !== !1,
            ...
            t.items.length
              ? n(
                  'div',
                  { staticClass: 'k-block-faq-list' },
                  t._l(t.items, function (r, i) {
                    return n(
                      'article',
                      {
                        key: r.id || i,
                        staticClass: 'k-block-faq-item',
                        class: { 'is-open': t.isOpen(i) },
                      },
                      [
                        n(
                          'button',
                          {
                            staticClass: 'k-block-faq-toggle',
                            attrs: { type: 'button' },
                            on: {
                              click: function (a) {
                                return (a.stopPropagation(), t.toggleItem(i));
                              },
                            },
                          },
                          [
                            ...
                            n('div', { staticClass: 'k-block-faq-preview' }, [
                              t._v(' ' + t._s(t.questionValue(r) || 'Frage eingeben…') + ' '),
                            ]),
                            n('k-icon', {
                              staticClass: 'k-block-faq-icon',
                              attrs: { type: 'angle-down' },
                            }),
                          ],
                          1
                        ...
                        t.isOpen(i)
                          ? n('div', { staticClass: 'k-block-faq-body' }, [
                              n('textarea', {
                                staticClass: 'k-block-faq-answer-input',
                                attrs: { rows: '1', placeholder: 'Antwort eingeben…' },
                                domProps: { value: t.stripHtml(t.answerValue(r)) },
                                on: {
                                  input: function (a) {
                                    (t.updateItem(
                                      i,
                                      r.content.answer !== void 0 ? 'answer' : 'details',
                                      a.target.value
                                    ),
                                      t.resizeTextarea(a.target));
                                  },
                                },
                              }),
                            ])
              ...
              : n('div', { staticClass: 'k-block-empty' }, [t._v(' Noch keine FAQ-Einträge ')]),
          ],
          1
        ),
      ]);
                  ...
                  [
                    t._l(t.displayEntries, function (r, i) {
                      ...
                      return n('div', { key: i, staticClass: 'k-block-timeline-item' }, [
                        ...
                        (a = r.image) != null && a.length
                          ? n('div', { staticClass: 'k-block-timeline-image' }, [
                              n('img', { attrs: { src: r.image[0].url, alt: '' } }),
                            ])
                          : t._e(),
                      ]);
                    }),
    ...
    et = {
      ...
      computed: {
        ...
        fieldConfig() {
          var e, t;
          return (
            ((t = (e = this.fieldset) == null ? void 0 : e.fields) == null ? void 0 : t.form) ||
            null
          );
        },
        selectedForm() {
          return (Array.isArray(this.formValue) && this.formValue[0]) || null;
        },
        hasSelection() {
      ...
      methods: {
        async loadForms() {
          if (!this.formsLoaded)
            try {
              const e = await this.$api.get('gs-mmh-web-plugin/forms');
          ...
          (e = this.$panel) != null &&
            ...
            this.$panel.dialog.open({
              ...
              props: {
                fields: {
                  form: {
                    label: ((t = this.fieldConfig) == null ? void 0 : t.label) || 'Formulare',
                    type: 'select',
                    options: this.forms,
                    value: ((n = this.selectedForm) == null ? void 0 : n.id) || '',
              ...
              on: {
                submit: r => {
                  var c, l;
                  const i = r.form || '',
                    a = this.forms.find(o => o.value === i);
                  (this.updateForm(a ? [{ id: a.value, text: a.text }] : []),
                    (l = (c = this.$panel) == null ? void 0 : c.dialog) == null || l.close());
                },
                cancel: () => {
                  var r, i;
          ...
          n('div', { staticClass: 'k-block-type-form-field' }, [
            n(
              'div',
              {
                ...
                on: {
                  click: function (r) {
                    return (r.stopPropagation(), t.openPicker.apply(null, arguments));
                  },
                },
              },
              [
                n('div', { staticClass: 'k-block-type-form-display-main' }, [
                  n(
                    'div',
                    { staticClass: 'k-block-type-form-file-icon' },
                    [n('k-icon', { attrs: { type: 'survey' } })],
                    1
                  ),
                ...
                t.hasSelection
                  ? n(
                      'button',
                      {
                        ...
                        on: {
                          click: function (r) {
                            return (r.stopPropagation(), t.clearSelection.apply(null, arguments));
                          },
                        },
                      },
                      [t._v(' ⊖ ')]
  ...
  const _t = ft.exports,
    ...
    kt = {
      get button() {
        return { icon: 'circle', label: 'Button' };
      },
      commands() {
        return {
          button: e => {
    ...
    vt = {
      get button() {
        return { icon: 'sparkling', label: 'Highlight' };
      },
      commands() {
  ...
  const Ft = Ct.exports,
    Tt = {
      ...
      methods: {
        ...
        showDetail(e) {
          this.$panel.dialog.open('dreamform-db/' + this.resourceKey + '/' + e);
        },
        confirmDelete(e) {
          this.$panel.dialog.open('dreamform-db/' + this.resourceKey + '/' + e + '/delete');
        },
        goToPage(e) {
      ...
      computed: {
        scheduleLabel() {
          ...
          const e = new Intl.DateTimeFormat('de-DE', {
            ...
            t =
              (r = this.attrs) != null && r.publish_date
                ? e.format(new Date(String(this.attrs.publish_date).replace(' ', 'T')))
                : null,
            n =
              (i = this.attrs) != null && i.end_date
  ...
  panel.plugin('gs-mmh/gs-mmh-web-plugin', {
    ...
    writerMarks: { badge: bt, button: kt, footnote: yt, highlight: vt },
    components: { 'k-layout': Bt, 'k-dreamform-db-overview': Ft, 'k-dreamform-db-form': St },
  });
})();
