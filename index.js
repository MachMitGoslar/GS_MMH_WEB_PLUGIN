(function () {
        ...
        [
          ...
          t.buttonItems.length > 0
            ? n(
                ...
                t._l(t.buttonItems, function (r, a) {
                  return n(
                    'button',
                    {
                      class: ['k-panel-button'],
          ...
          n('div', { staticClass: 'k-block-body' }, [
            ...
            t.hasEntries
              ? n(
                  ...
                  [
                    t._l(t.displayEntries, function (r, a) {
                      return n('div', { key: a, staticClass: 'k-block-timeline-item' }, [
      ...
      get schema() {
        return {
          ...
          toDOM(e) {
            ...
            switch (n) {
              case 'secondary':
                a = 'background-color: #C6C6C6; color: #3F3F3E;';
                break;
              case 'success':
                a = 'background-color: #10b981; color: white;';
                break;
              case 'warning':
                a = 'background-color: #f59e0b; color: white;';
                break;
              case 'error':
              ...
              case 'primary':
              default:
                a = 'background-color: #FCCE4C; color: #222222;';
                break;
            }
            return ['span', { class: 'badge', 'data-variant': n || 'primary', style: r + a }, 0];
          },
        };
      },
      toggle() {
                      ...
                      t._l(t.submissions, function (r) {
                        return n(
                          ...
                          [
                            ...
                            t._l(t.displayColumns, function (a) {
                              return n('td', { key: a }, [t._v(t._s(t.truncate(r.data[a])))]);
                            }),
                            n(
                              'td',
                              {
  ...
  panel.plugin('gs-mmh/gs-mmh-web-plugin', {
    ...
    writerMarks: { badge: lt, button: ct, footnote: dt, highlight: ut },
    components: { 'k-dreamform-db-overview': ht, 'k-dreamform-db-form': yt },
  });
})();
